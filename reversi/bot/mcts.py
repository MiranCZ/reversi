...
class Mcts:
    ...
    def get_best_move(self, board, is_white_playing):
        ...
        """
        white, black = self.__parse_board(board)

        move, score = montecarlo.best_move(white, black, is_white_playing, self.seconds_per_move)
    ...
    @staticmethod
    def __parse_board(board: list[list[str]]):
        white: int = 0
        black: int = 0
